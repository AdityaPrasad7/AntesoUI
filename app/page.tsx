        ...
        <div className="max-w-4xl 2xl:max-w-7xl 3xl:max-w-9xl 4xl:max-w-11xl 5xl:max-w-13xl 6xl:max-w-14xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-[1.25fr_0.75fr] gap-12 2xl:gap-16 3xl:gap-20 4xl:gap-24 items-center">
            <div className="space-y-8 2xl:space-y-10 3xl:space-y-12 4xl:space-y-16">
              ...
              <div className="flex flex-row sm:flex-row gap-3 sm:gap-4 2xl:gap-6 3xl:gap-8 animate-fade-in-up delay-400">
                <a href="#services" className="flex-1 sm:flex-none px-4 py-2.5 sm:px-6 2xl:px-8 2xl:py-3 3xl:px-10 3xl:py-3.5 4xl:px-12 4xl:py-4 rounded-lg bg-gradient-to-r from-accent to-primary text-accent-foreground text-xs sm:text-sm 2xl:text-base 3xl:text-lg 4xl:text-xl font-medium hover:shadow-lg hover:shadow-accent/20 transition-all flex items-center justify-center gap-2">
                  Explore Solutions <ArrowRight className="w-3 h-3 sm:w-4 sm:h-4 2xl:w-5 2xl:h-5 3xl:w-6 3xl:h-6 4xl:w-7 4xl:h-7" />
                </a>
                <Link href="/contact" className="flex-1 sm:flex-none px-4 py-2.5 sm:px-6 2xl:px-8 2xl:py-3 3xl:px-10 3xl:py-3.5 4xl:px-12 4xl:py-4 rounded-lg border border-accent/30 text-foreground text-xs sm:text-sm 2xl:text-base 3xl:text-lg 4xl:text-xl font-medium hover:bg-accent/5 transition-colors text-center sm:text-left">
                  Learn More
                </Link>
              </div>
